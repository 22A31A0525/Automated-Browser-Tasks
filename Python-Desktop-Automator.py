...
def searches_perform(perm_word):
    ...
    for i in perm_word:
        for j in search_bar[0:4]:
            pyautogui.leftClick(random.randint(j[0],j[0]+10),random.randint(j[1],j[1]+10))
...
user_lst = ["Profile 5","Profile 8","Profile 6","Profile 7","Profile 3","Profile 2","Profile 1","Profile 9","Profile 22","Profile 11","Profile 14","Profile 13","Profile 15","Profile 19","Profile 21","Profile 0"]
...
def search_engine(users):
    ...
    while i <16:
        ...
        arrange() 
        searches_perform(permutation_generator("cyber"))
        time.sleep(1)
